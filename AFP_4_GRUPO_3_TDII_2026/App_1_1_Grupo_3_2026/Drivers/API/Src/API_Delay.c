...
/**
  * @brief  Actualiza la duración del tiempo de retardo. Si no se agrega un
  *         valor de delay, la duración sigue actualizándose. Cuando se cambia
  *         el valor de tiempo, la duración se actualizará siendo el valor
  *         establecido de "delay".
  * @param  delay: Puntero a la estructura delay_t
